                            ...
                            <table class='email-body_inner' align='center' width='570' cellpadding='0' cellspacing='0'
                                ...
                                <tr>
                                    <td class='content-cell'
                                        ...
                                        <img alt="Reachup"
                                            style="margin:30px auto;width: 50%;display: block; background:#f39c12; padding: 10px;"
                                            src="https://reachup.us/public/dist/img/w-logo.png">
                                        ...
                                        <p style='box-sizing: border-box; color: #74787E; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;'
                                            align='left'>Your email has been linked for Paypal transactions
                                        </p>
                                        <p style='box-sizing: border-box; color: #74787E; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;'
                                            align='left'>Your id <strong>{{ $user->paypal_email ?? $user->email }}</strong> is now associated with reachup transactions.
                                            <br />All your transactions will be send to this paypal account.
                                        </p>
                                        <p style='box-sizing: border-box; color: #74787E; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;'
                                            align='left'>Thanks,
                                            <br />The Reachup Team
                                ...
                                <tr>
                                    <td class='content-cell' align='center'
                                        ...
                                        <p class='sub align-center'
                                            ...
                                            align='center'>© 2021 Reachup. All rights reserved.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
