                                            ...
                                            <div class="d-flex row">
                                                ...
                                                <div class="card card-body text-center col-5 m-4" style="height: 150px; border-radius:30px;">
                                                    <div class="mb-3">
                                                        ...
                                                        {{-- <span class="d-block">{{ $device->following_user->name }}</span>
                                                        <span class="d-block">{{ $device->following_user->email }}</span>
                                                        <span class="d-block">{{ $device->following_user->phone }}</span> --}}
